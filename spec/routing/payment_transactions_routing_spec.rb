...
RSpec.describe PaymentTransactionsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(get: "/payment_transactions/new").to route_to("payment_transactions#new")
    end
    ...
    it "routes to #edit" do
      expect(get: "/payment_transactions/1/edit").to route_to("payment_transactions#edit", id: "1")
    end
